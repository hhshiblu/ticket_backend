...
// Admin Analytics
router.get("/analytics", adminController.getAdminAnalytics.bind(adminController));
...
router.put("/vendors/:vendorId/status", adminController.updateVendorStatus.bind(adminController));

// Event Management
router.get("/events", adminController.getAllEvents.bind(adminController));
router.put("/events/:eventId/status", adminController.updateEventStatus.bind(adminController));
...
router.put("/settings", adminController.updateSystemSettings.bind(adminController));
